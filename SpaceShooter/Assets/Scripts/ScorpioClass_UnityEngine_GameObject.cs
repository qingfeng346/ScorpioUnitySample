...
public class ScorpioClass_UnityEngine_GameObject : ScorpioFastReflectClass {
    ...
    public object GetValue(object obj, string name) {
        switch (name) {
            case "activeInHierarchy": return ((UnityEngine.GameObject)obj).activeInHierarchy;
            case "activeSelf": return ((UnityEngine.GameObject)obj).activeSelf;
            case "gameObject": return ((UnityEngine.GameObject)obj).gameObject;
            case "hideFlags": return ((UnityEngine.GameObject)obj).hideFlags;
            case "isStatic": return ((UnityEngine.GameObject)obj).isStatic;
            case "layer": return ((UnityEngine.GameObject)obj).layer;
            case "name": return ((UnityEngine.GameObject)obj).name;
            case "scene": return ((UnityEngine.GameObject)obj).scene;
            case "tag": return ((UnityEngine.GameObject)obj).tag;
            case "transform": return ((UnityEngine.GameObject)obj).transform;
            case "AddComponent": return ScorpioClass_UnityEngine_GameObject_AddComponent.GetInstance();
            case "BroadcastMessage": return ScorpioClass_UnityEngine_GameObject_BroadcastMessage.GetInstance();
            case "CompareTag": return ScorpioClass_UnityEngine_GameObject_CompareTag.GetInstance();
            case "CreatePrimitive": return ScorpioClass_UnityEngine_GameObject_CreatePrimitive.GetInstance();
            ...
            case "TestFunc": return ScorpioClass_UnityEngine_GameObject_TestFunc.GetInstance();
            case "ToString": return ScorpioClass_UnityEngine_GameObject_ToString.GetInstance();
            default: throw new ExecutionException("UnityEngine.GameObject [GetValue] 找不到变量 : " + name);
        }
    }
